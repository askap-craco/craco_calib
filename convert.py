...
def main(args):
    if args.vis is None:
        raise ValueError("Need to provide an input vis ms to process")
    else:
        ms = args.vis
    if args.outvis is None:
        msout = ms.strip("ms") + "4pol.ms"
    else:
        msout = args.outvis
...
if __name__ == '__main__':
    ...
    a.add_argument("-vis", type=str, help="Path to the inp vis ms")
    a.add_argument("-outvis", type=str, help="Path to the output vis ms")
