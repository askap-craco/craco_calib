...
if len(sys.argv) < 4:
    print("Usage: %s ms_file PB_radii flux_cutoff")
ms_name = sys.argv[1]
pb_radii = float(sys.argv[2])
flux_cutoff = float(sys.argv[3]) #0.020  # Jy
spectral_index = -0.83 # Median for 843-1400 MHz Mauch et al. (2003)
